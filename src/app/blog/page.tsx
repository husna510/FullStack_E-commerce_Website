...
const RecentPosts = () => {
  const posts = [
    { src: '/images/pro1.svg', title: 'Going all-in with millennial design' },
    { src: '/images/pro2.svg', title: 'Exploring new ways of decorating' },
    { src: '/images/pro3.svg', title: 'Handmade pieces that took time to make' },
    { src: '/images/pro4.svg', title: 'Modern home in Milan' },
    { src: '/images/pro5.svg', title: 'Colorful office redesign' },
  ];
